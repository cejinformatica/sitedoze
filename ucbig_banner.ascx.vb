        ...
        For wCount As Integer = 0 To aBigBanners.Count - 1
            ...
            Else
                ...
                If aBigBanners(wCount).tLink <> "" Then
                    ...
                    wTagImg += "[" & Chr(34) & wURL & Chr(34) & "','" & Chr(34) & wHTTP & aBigBanners(wCount).tLink.Trim & Chr(34) & ", " & Chr(34) & aBigBanners(wCount).tTipoLink.trim & Chr(34) & ", ""] "
                                  Else

                    wTagImg += "[" & Chr(34) & wURL & Chr(34) & "],"
