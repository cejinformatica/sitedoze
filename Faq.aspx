...
<%@ Register Src="ucFaq.ascx" TagName="ucFaq" TagPrefix="uc17" %>
<%@ Register Src="ucDownloads.ascx" TagName="ucDownloads" TagPrefix="uc16" %>
...
<head id="Head1" runat="server">
    <title>Portal - Central de Downloads</title>
...
<tr>
<td valign="top" height=179px >
     <uc3:ucbig_banner ID="Ucbig_banner1" runat="server" /></td>
</tr>
<tr>
...
<td valign="top" width="850">
    <table cellpadding="0"  cellspacing="0"   width="100%">
        ...
        <tr>
            <td valign="top">
                <uc17:ucFaq ID="UcFaq1" runat="server" />
            </td>
        </tr>
    </table>
