...
<body>
    ...
    <div></div>
    <table  align="center"  class="tabela_principal" bgcolor="#ffffff" width="905">
<tr>
<td valign="top" >
...
<td valign="top" width="850">
    <radA:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%">
        <asp:GridView ID="gvResultados" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="0"  AllowPaging="True">
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
