...
<rad:RadAjaxPanel ID="rapEventos" runat="server">
    <table  width="100%" >
     <tr>
             <td class="TxtTituloNoticia" align=left colspan=3>
                            Calendário</td>
        </tr>
        <tr>
        ...
        <tr>
            <td valign=top class="Resenha">
                ...
                <asp:DataList ID="PEventos" runat="server" Width="100%">
                    <ItemTemplate>
                        <table   width="100%" id="tbEventos">
                            <tr>
                                <td align="left">
                                    <a href='<%# "DetalhesEventos.aspx?id=" & DataBinder.Eval(Container.DataItem, "cEvento")%>' class=resenha>
