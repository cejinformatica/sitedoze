...
Partial Class ucVideos
    ...
    Function fCarregarCodigoVideo(ByVal wCodigoVideo As String) As String
        ...
        wObjeto = "<object width='946' height='400'>"
        ...
        wObjeto += "<embed src='http://www.youtube.com/v/---CODIGOVIDEO---&hl=pt_BR&fs=1&' type='application/x-shockwave-flash' allowscriptaccess='always' allowfullscreen='true' width='946' height='420'></embed>"
        wObjeto += "</object>"
