...
Partial Class ucPublicidade
    ...
    Function fRetornaPublicidade(ByVal wArquivo As String, ByVal wTipoBAnner As Integer, ByVal wLink As String) As String
        ...
        If wTipoBAnner = 1 Then
            ...
            wTagImg = " <object id=" & Chr(34) & "FlashID" & Chr(34) & " classid=" & Chr(34) & "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" & Chr(34) & " width=" & Chr(34) & "190" & Chr(34) & " height=" & Chr(34) & "67" & Chr(34) & ">"
        ...
        Else
            ...
            If wLink <> "" Then
                ...
                wTagImg = "<a href=" & Chr(34) & "http://" & wLink.Trim & Chr(34) & " target=" & Chr(34) & "_blank " & Chr(34) & "><img src=" & Chr(34) & wURL & Chr(34) & " style=" & Chr(34) & "width: 180; height: 67px" & Chr(34) & " /></a>"

            Else

                wTagImg = "<img src=" & Chr(34) & wURL & Chr(34) & " style=" & Chr(34) & "width: 180; height: 67px" & Chr(34) & " />"
